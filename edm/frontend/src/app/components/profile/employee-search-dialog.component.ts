...
@Component({
  ...
  styleUrls: ['./employee-search-dialog.component.css'],

  encapsulation: ViewEncapsulation.None
})
export class EmployeeSearchDialogComponent implements OnInit {
  ...
  constructor( private _employeesService : EmployeesService,
               ...
               public dialogRef: MatDialogRef<ProfileComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {}
